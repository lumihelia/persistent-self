# Maintaining Persistent Self

This file governs contributions to this public protocol repository. It is not the instruction snippet installed into a user's project.
...
- Template changes must preserve an upgrade path for existing users. Do not instruct users to overwrite populated memory stores or existing host instructions.
