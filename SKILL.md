...
2. Read `procedures.md` in full — these rules apply to every interaction.
3. From INDEX.md summaries, identify which modules are relevant to this session.
4. Load selected modules only.
5. Integrate content into context. Do not report what was loaded unless asked.
...
4. Regenerate INDEX.md: update the one-line summary for each changed module.
